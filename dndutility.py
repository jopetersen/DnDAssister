...
# "You have 6 Ability scores to roll for: Strength, Dexterity, Constitution, Intellect, and Wisdom. 
...
entered_num_dice = int(input("Enter a number that is 4 "))
# this isn't great... need to make this more dynamic
...
def dice_array_builder(entered_num_dice):
...
dice_array_builder(entered_num_dice)